...
from postnlecommerceapis.models.labelling_request import LabellingRequest
...
class LabellingControllerTests(ControllerTestBase):
    ...
    def test_generate_a_label_and_confirmation(self):
        ...
        result = self.controller.generate_a_label_and_confirmation(body, confirm)
