...
from postnlecommerceapis.models.confirming_request import ConfirmingRequest
...
class ConfirmingControllerTests(ControllerTestBase):
    ...
    def test_confirm_a_shipment_to_post_nl(self):
        ...
        result = self.controller.confirm_a_shipment_to_post_nl(body)
