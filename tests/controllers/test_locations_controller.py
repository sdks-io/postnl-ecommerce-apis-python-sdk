...
class LocationsControllerTests(ControllerTestBase):
    ...
    #```
    #
    def test_returns_pickup_locations_nearest_to_the_provided_address(self):
        ...
        result = self.controller.returns_pickup_locations_nearest_to_the_provided_address(country_code, postal_code, city, street, house_number, house_number_extension, delivery_date, opening_time, delivery_options)
    ...
    #```
    #
    def test_returns_pickup_locations_nearest_to_the_provided_coordinates(self):
        # Parameters for the API call
        ...
        # Perform the API call through the SDK function
        result = self.controller.returns_pickup_locations_nearest_to_the_provided_coordinates(latitude, longitude, country_code, delivery_date, opening_time, delivery_options)
    ...
    #```
    #
    def test_returns_pickup_locations_within_a_provided_area(self):
        # Parameters for the API call
        ...
        # Perform the API call through the SDK function
        result = self.controller.returns_pickup_locations_within_a_provided_area(latitude_north, longitude_west, latitude_south, longitude_east, country_code, delivery_date, opening_time, delivery_options)
    ...
    #```
    #
    def test_returns_a_specific_pickup_location(self):
        # Parameters for the API call
        location_code = '216877'

        # Perform the API call through the SDK function
        result = self.controller.returns_a_specific_pickup_location(location_code)
