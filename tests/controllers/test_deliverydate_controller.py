...
class DeliverydateControllerTests(ControllerTestBase):
    ...
    #```
    #
    def test_calculate_required_shipping_date(self):
        ...
        result = self.controller.calculate_required_shipping_date(delivery_date, shipping_duration, postal_code, country_code, origin_country_code, city, street, house_number, house_nr_ext)
