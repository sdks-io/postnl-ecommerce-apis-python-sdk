...
from postnlecommerceapis.models.shipment_v_22_calculate_date_delivery_response import ShipmentV22CalculateDateDeliveryResponse
from postnlecommerceapis.models.shipment_v_22_calculate_date_shipping_response import ShipmentV22CalculateDateShippingResponse
from postnlecommerceapis.exceptions.deliverydate_response_invalid_exception import DeliverydateResponseInvalidException
from postnlecommerceapis.exceptions.post_cif_delivery_date_unauthorized_exception import PostCIFDeliveryDateUnauthorizedException
from postnlecommerceapis.exceptions.post_cif_delivery_date_method_not_allowed_exception import PostCIFDeliveryDateMethodNotAllowedException
from postnlecommerceapis.exceptions.post_cif_delivery_date_too_many_request_exception import PostCIFDeliveryDateTooManyRequestException
from postnlecommerceapis.exceptions.deliverydate_response_error_exception import DeliverydateResponseErrorException
...
class DeliverydateController(BaseController):
    ...
    def calculate_expected_delivery_date(self,
        ...
        Args:
            ...
            country_code (CountryCode1Enum): The ISO2 destination country
                code
        ...
        Returns:
            ShipmentV22CalculateDateDeliveryResponse: Response from the API.
                Expected earliest delivery date
        ...
        return super().new_api_call_builder.request(
            ...
            .local_error('401', 'Invalid apikey', PostCIFDeliveryDateUnauthorizedException)
            .local_error('405', 'Method not allowed', PostCIFDeliveryDateMethodNotAllowedException)
            .local_error('429', 'Too many requests', PostCIFDeliveryDateTooManyRequestException)
            .local_error('500', 'Internal server error', DeliverydateResponseErrorException)
        ).execute()
    ...
    def calculate_required_shipping_date(self,
        ...
        Returns:
            ShipmentV22CalculateDateShippingResponse: Response from the API.
                The calculated date that the parcel needs to be shipped to
                PostNL
