...
from postnlecommerceapis.models.address_5 import Address5
from postnlecommerceapis.models.amount_1 import Amount1
from postnlecommerceapis.models.customer_1 import Customer1
from postnlecommerceapis.models.dimension_1 import Dimension1
from postnlecommerceapis.models.event import Event
from postnlecommerceapis.models.expectation import Expectation
from postnlecommerceapis.models.old_status import OldStatus
from postnlecommerceapis.models.product_options import ProductOptions
from postnlecommerceapis.models.status import Status
...
class Shipment1(object):
    ...
    Attributes:
        ...
        address (List[Address5]): A list of addresses belonging to the
            shipment
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('Address') is not None:
            address = [Address5.from_dictionary(x) for x in dictionary.get('Address')]
        else:
            address = APIHelper.SKIP
        event = None
