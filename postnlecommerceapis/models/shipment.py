...
from postnlecommerceapis.models.address_4 import Address4
from postnlecommerceapis.models.amount import Amount
from postnlecommerceapis.models.contact import Contact
from postnlecommerceapis.models.custom import Custom
...
from postnlecommerceapis.models.product_option import ProductOption
...
class Shipment(object):
    ...
    Attributes:
        addresses (List[Address4]): List of 1 or more Address type elements.
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('Addresses') is not None:
            addresses = [Address4.from_dictionary(x) for x in dictionary.get('Addresses')]
