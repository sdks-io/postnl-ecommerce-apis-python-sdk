...
from postnlecommerceapis.models.address_2 import Address2
from postnlecommerceapis.models.delivery_options import DeliveryOptions
from postnlecommerceapis.models.opening_hours_1 import OpeningHours1
from postnlecommerceapis.models.sustainability_2 import Sustainability2
...
class Location1(object):
    ...
    Attributes:
        ...
        opening_hours (OpeningHours1): The standard opening times of the
            pickup location
        sustainability (Sustainability2): Sustainability score; see
    ...
    def from_dictionary(cls,
        ...
        opening_hours = OpeningHours1.from_dictionary(dictionary.get('OpeningHours')) if 'OpeningHours' in dictionary.keys() else APIHelper.SKIP
        sustainability = Sustainability2.from_dictionary(dictionary.get('Sustainability')) if 'Sustainability' in dictionary.keys() else APIHelper.SKIP
