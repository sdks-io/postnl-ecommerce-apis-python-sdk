...
from postnlecommerceapis.models.options_2 import Options2
...
class TimeframeTimeframe(object):
    ...
    Attributes:
        ...
        options (Options2): The delivery option for which the timeframe is
    ...
    def from_dictionary(cls,
        ...
        options = Options2.from_dictionary(dictionary.get('Options')) if 'Options' in dictionary.keys() else APIHelper.SKIP
