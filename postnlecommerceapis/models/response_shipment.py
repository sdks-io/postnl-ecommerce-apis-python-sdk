...
from postnlecommerceapis.models.error_6 import Error6
from postnlecommerceapis.models.warning_1 import Warning1
...
class ResponseShipment(object):
    ...
    Attributes:
        errors (List[Error6]): Possible errors. See the [Error
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('Errors') is not None:
            errors = [Error6.from_dictionary(x) for x in dictionary.get('Errors')]
        else:
            errors = APIHelper.SKIP
        warnings = None
