...
from postnlecommerceapis.models.label_1 import Label1
from postnlecommerceapis.models.warnings_1 import Warnings1
...
class ResponseShipment1(object):
    ...
    Attributes:
        ...
        warnings (List[Warnings1]): Possible warnings. See the [Error
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('Warnings') is not None:
            warnings = [Warnings1.from_dictionary(x) for x in dictionary.get('Warnings')]
        else:
            warnings = APIHelper.SKIP
