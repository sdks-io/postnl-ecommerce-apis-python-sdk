...
from postnlecommerceapis.models.options_3 import Options3
from postnlecommerceapis.models.sustainability_4 import Sustainability4
...
class ReasonNoTimeframe(object):
    ...
    Attributes:
        ...
        options (Options3): The option for which no timeframe was calculated
            for a specific date
        sustainability (Sustainability4): Sustainability score
    ...
    def from_dictionary(cls,
        ...
        options = Options3.from_dictionary(dictionary.get('Options')) if 'Options' in dictionary.keys() else APIHelper.SKIP
        sustainability = Sustainability4.from_dictionary(dictionary.get('Sustainability')) if 'Sustainability' in dictionary.keys() else APIHelper.SKIP
