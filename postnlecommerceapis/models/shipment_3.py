...
from postnlecommerceapis.models.address_8 import Address8
from postnlecommerceapis.models.amount_2 import Amount2
from postnlecommerceapis.models.contact_1 import Contact1
from postnlecommerceapis.models.dimension import Dimension
from postnlecommerceapis.models.extra_field import ExtraField
from postnlecommerceapis.models.group import Group
from postnlecommerceapis.models.hazardous_material import HazardousMaterial
from postnlecommerceapis.models.product_options_2 import ProductOptions2


class Shipment3(object):

    """Implementation of the 'Shipment3' model.

    TODO: type model description here.

    Attributes:
        addresses (List[Address8]): List of 1 or more Address type elements.
            At least 1 address type is mandatory. See [Address
            types](#tag/Reference-codes/Address-types) for the available
            types.
        amounts (List[Amount2]): List of amount types. An amount represents a
        ...
        contacts (List[Contact1]): One or more ContactType elements belonging
        ...
        customs (object): The Customs type is mandatory for non-EU shipments
            and not allowed for any other shipment types.
        required (object): TODO: type description here.
        ...
        product_options (List[ProductOptions2]): Product options for the
    ...
    def __init__(self,
        ...
        """Constructor for the Shipment3 class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('Addresses') is not None:
            addresses = [Address8.from_dictionary(x) for x in dictionary.get('Addresses')]
        ...
        if dictionary.get('Amounts') is not None:
            amounts = [Amount2.from_dictionary(x) for x in dictionary.get('Amounts')]
        else:
            amounts = APIHelper.SKIP
        ...
        if dictionary.get('Contacts') is not None:
            contacts = [Contact1.from_dictionary(x) for x in dictionary.get('Contacts')]
        else:
            contacts = APIHelper.SKIP
        ...
        customs = dictionary.get("Customs") if dictionary.get("Customs") else APIHelper.SKIP
        required = dictionary.get("required") if dictionary.get("required") else APIHelper.SKIP
        ...
        if dictionary.get('ProductOptions') is not None:
            product_options = [ProductOptions2.from_dictionary(x) for x in dictionary.get('ProductOptions')]
        else:
            product_options = APIHelper.SKIP
