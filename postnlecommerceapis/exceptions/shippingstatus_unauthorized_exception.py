...
class ShippingstatusUnauthorizedException(postnlecommerceapis.exceptions.api_exception.APIException):
    def __init__(self, reason, response):
        """Constructor for the ShippingstatusUnauthorizedException class
        ...
        """
        super(ShippingstatusUnauthorizedException, self).__init__(reason, response)
