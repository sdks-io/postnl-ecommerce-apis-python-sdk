...
class BarcodeMethodNotAllowedException(postnlecommerceapis.exceptions.api_exception.APIException):
    def __init__(self, reason, response):
        """Constructor for the BarcodeMethodNotAllowedException class
        ...
        """
        super(BarcodeMethodNotAllowedException, self).__init__(reason, response)
