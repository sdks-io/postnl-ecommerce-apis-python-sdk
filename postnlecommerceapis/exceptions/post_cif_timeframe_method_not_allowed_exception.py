...
class PostCIFTimeframeMethodNotAllowedException(postnlecommerceapis.exceptions.api_exception.APIException):
    def __init__(self, reason, response):
        """Constructor for the PostCIFTimeframeMethodNotAllowedException class
        ...
        """
        super(PostCIFTimeframeMethodNotAllowedException, self).__init__(reason, response)
