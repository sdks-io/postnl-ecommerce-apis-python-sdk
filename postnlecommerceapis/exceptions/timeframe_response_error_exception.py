...
class TimeframeResponseErrorException(postnlecommerceapis.exceptions.api_exception.APIException):
    def __init__(self, reason, response):
        """Constructor for the TimeframeResponseErrorException class
        ...
        """
        super(TimeframeResponseErrorException, self).__init__(reason, response)
