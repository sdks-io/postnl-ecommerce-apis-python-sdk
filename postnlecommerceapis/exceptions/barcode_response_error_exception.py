...
class BarcodeResponseErrorException(postnlecommerceapis.exceptions.api_exception.APIException):
    def __init__(self, reason, response):
        ...
        """
        super(BarcodeResponseErrorException, self).__init__(reason, response)
