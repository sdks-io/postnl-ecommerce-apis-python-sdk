...
class DeliverydateResponseErrorException(postnlecommerceapis.exceptions.api_exception.APIException):
    def __init__(self, reason, response):
        """Constructor for the DeliverydateResponseErrorException class
        ...
        """
        super(DeliverydateResponseErrorException, self).__init__(reason, response)
