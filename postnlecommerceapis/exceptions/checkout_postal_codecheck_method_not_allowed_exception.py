...
class CheckoutPostalCodecheckMethodNotAllowedException(postnlecommerceapis.exceptions.api_exception.APIException):
    def __init__(self, reason, response):
        """Constructor for the CheckoutPostalCodecheckMethodNotAllowedException class
        ...
        """
        super(CheckoutPostalCodecheckMethodNotAllowedException, self).__init__(reason, response)
