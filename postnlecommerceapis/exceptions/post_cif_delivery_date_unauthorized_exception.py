...
class PostCIFDeliveryDateUnauthorizedException(postnlecommerceapis.exceptions.api_exception.APIException):
    def __init__(self, reason, response):
        """Constructor for the PostCIFDeliveryDateUnauthorizedException class
        ...
        """
        super(PostCIFDeliveryDateUnauthorizedException, self).__init__(reason, response)
