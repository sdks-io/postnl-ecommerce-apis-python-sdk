...
class ShippingstatusTooManyRequestException(postnlecommerceapis.exceptions.api_exception.APIException):
    def __init__(self, reason, response):
        """Constructor for the ShippingstatusTooManyRequestException class
        ...
        """
        super(ShippingstatusTooManyRequestException, self).__init__(reason, response)
