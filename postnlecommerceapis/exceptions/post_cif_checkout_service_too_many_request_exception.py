...
class PostCIFCheckoutServiceTooManyRequestException(postnlecommerceapis.exceptions.api_exception.APIException):
    def __init__(self, reason, response):
        """Constructor for the PostCIFCheckoutServiceTooManyRequestException class
        ...
        """
        super(PostCIFCheckoutServiceTooManyRequestException, self).__init__(reason, response)
