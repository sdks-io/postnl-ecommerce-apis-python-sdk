...
class PostCIFTimeframeTooManyRequestException(postnlecommerceapis.exceptions.api_exception.APIException):
    def __init__(self, reason, response):
        """Constructor for the PostCIFTimeframeTooManyRequestException class
        ...
        """
        super(PostCIFTimeframeTooManyRequestException, self).__init__(reason, response)
