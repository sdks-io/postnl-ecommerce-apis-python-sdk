...
class LabellingUnauthorizedException(postnlecommerceapis.exceptions.api_exception.APIException):
    def __init__(self, reason, response):
        """Constructor for the LabellingUnauthorizedException class
        ...
        """
        super(LabellingUnauthorizedException, self).__init__(reason, response)
