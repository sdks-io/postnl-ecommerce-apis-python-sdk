...
class LabellingTooManyRequestException(postnlecommerceapis.exceptions.api_exception.APIException):
    def __init__(self, reason, response):
        """Constructor for the LabellingTooManyRequestException class
        ...
        """
        super(LabellingTooManyRequestException, self).__init__(reason, response)
