...
class ShippingstatusMethodNotAllowedException(postnlecommerceapis.exceptions.api_exception.APIException):
    def __init__(self, reason, response):
        """Constructor for the ShippingstatusMethodNotAllowedException class
        ...
        """
        super(ShippingstatusMethodNotAllowedException, self).__init__(reason, response)
