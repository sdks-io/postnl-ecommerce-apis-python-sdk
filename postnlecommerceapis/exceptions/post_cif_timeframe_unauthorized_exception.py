...
class PostCIFTimeframeUnauthorizedException(postnlecommerceapis.exceptions.api_exception.APIException):
    def __init__(self, reason, response):
        """Constructor for the PostCIFTimeframeUnauthorizedException class
        ...
        """
        super(PostCIFTimeframeUnauthorizedException, self).__init__(reason, response)
