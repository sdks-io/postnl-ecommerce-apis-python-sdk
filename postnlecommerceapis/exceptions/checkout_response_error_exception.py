...
class CheckoutResponseErrorException(postnlecommerceapis.exceptions.api_exception.APIException):
    def __init__(self, reason, response):
        """Constructor for the CheckoutResponseErrorException class
        ...
        """
        super(CheckoutResponseErrorException, self).__init__(reason, response)
