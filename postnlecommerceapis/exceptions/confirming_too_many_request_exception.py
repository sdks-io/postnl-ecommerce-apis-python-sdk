...
class ConfirmingTooManyRequestException(postnlecommerceapis.exceptions.api_exception.APIException):
    def __init__(self, reason, response):
        """Constructor for the ConfirmingTooManyRequestException class
        ...
        """
        super(ConfirmingTooManyRequestException, self).__init__(reason, response)
