...
from postnlecommerceapis.models.error_5 import Error5


class BarcodeResponseInvalidException(postnlecommerceapis.exceptions.api_exception.APIException):
    ...
    def unbox(self, dictionary):
        ...
        if dictionary.get('errors') is not None:
            self.errors = [Error5.from_dictionary(x) for x in dictionary.get('errors')]
        else:
            self.errors = None
