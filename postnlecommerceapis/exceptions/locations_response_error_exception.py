...
class LocationsResponseErrorException(postnlecommerceapis.exceptions.api_exception.APIException):
    def __init__(self, reason, response):
        """Constructor for the LocationsResponseErrorException class
        ...
        """
        super(LocationsResponseErrorException, self).__init__(reason, response)
