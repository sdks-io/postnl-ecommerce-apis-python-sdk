...
from postnlecommerceapis.models.error_1 import Error1


class CheckoutResponseInvalidException(postnlecommerceapis.exceptions.api_exception.APIException):
    def __init__(self, reason, response):
        """Constructor for the CheckoutResponseInvalidException class
        ...
        """
        super(CheckoutResponseInvalidException, self).__init__(reason, response)
