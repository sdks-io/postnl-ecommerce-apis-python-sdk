...
class PostCIFDeliveryDateTooManyRequestException(postnlecommerceapis.exceptions.api_exception.APIException):
    def __init__(self, reason, response):
        """Constructor for the PostCIFDeliveryDateTooManyRequestException class
        ...
        """
        super(PostCIFDeliveryDateTooManyRequestException, self).__init__(reason, response)
