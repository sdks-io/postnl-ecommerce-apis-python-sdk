...
class PostCIFDeliveryDateMethodNotAllowedException(postnlecommerceapis.exceptions.api_exception.APIException):
    def __init__(self, reason, response):
        """Constructor for the PostCIFDeliveryDateMethodNotAllowedException class
        ...
        """
        super(PostCIFDeliveryDateMethodNotAllowedException, self).__init__(reason, response)
