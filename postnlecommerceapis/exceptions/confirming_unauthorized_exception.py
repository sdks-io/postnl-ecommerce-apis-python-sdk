...
class ConfirmingUnauthorizedException(postnlecommerceapis.exceptions.api_exception.APIException):
    def __init__(self, reason, response):
        """Constructor for the ConfirmingUnauthorizedException class
        ...
        """
        super(ConfirmingUnauthorizedException, self).__init__(reason, response)
