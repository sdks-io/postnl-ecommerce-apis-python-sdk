...
class CheckoutPostalCodecheckUnauthorizedException(postnlecommerceapis.exceptions.api_exception.APIException):
    def __init__(self, reason, response):
        """Constructor for the CheckoutPostalCodecheckUnauthorizedException class
        ...
        """
        super(CheckoutPostalCodecheckUnauthorizedException, self).__init__(reason, response)
