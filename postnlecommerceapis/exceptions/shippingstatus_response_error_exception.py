...
class ShippingstatusResponseErrorException(postnlecommerceapis.exceptions.api_exception.APIException):
    def __init__(self, reason, response):
        """Constructor for the ShippingstatusResponseErrorException class
        ...
        """
        super(ShippingstatusResponseErrorException, self).__init__(reason, response)
