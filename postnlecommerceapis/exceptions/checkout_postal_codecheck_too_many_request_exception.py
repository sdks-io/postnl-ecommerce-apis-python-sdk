...
class CheckoutPostalCodecheckTooManyRequestException(postnlecommerceapis.exceptions.api_exception.APIException):
    def __init__(self, reason, response):
        """Constructor for the CheckoutPostalCodecheckTooManyRequestException class
        ...
        """
        super(CheckoutPostalCodecheckTooManyRequestException, self).__init__(reason, response)
