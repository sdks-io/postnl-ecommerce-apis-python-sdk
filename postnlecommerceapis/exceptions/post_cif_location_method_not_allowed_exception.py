...
class PostCIFLocationMethodNotAllowedException(postnlecommerceapis.exceptions.api_exception.APIException):
    def __init__(self, reason, response):
        """Constructor for the PostCIFLocationMethodNotAllowedException class
        ...
        """
        super(PostCIFLocationMethodNotAllowedException, self).__init__(reason, response)
