...
class PostCIFCheckoutServiceMethodNotAllowedException(postnlecommerceapis.exceptions.api_exception.APIException):
    def __init__(self, reason, response):
        """Constructor for the PostCIFCheckoutServiceMethodNotAllowedException class
        ...
        """
        super(PostCIFCheckoutServiceMethodNotAllowedException, self).__init__(reason, response)
