...
class PostCIFCheckoutServiceUnauthorizedException(postnlecommerceapis.exceptions.api_exception.APIException):
    def __init__(self, reason, response):
        """Constructor for the PostCIFCheckoutServiceUnauthorizedException class
        ...
        """
        super(PostCIFCheckoutServiceUnauthorizedException, self).__init__(reason, response)
