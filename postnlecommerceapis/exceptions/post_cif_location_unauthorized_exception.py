...
class PostCIFLocationUnauthorizedException(postnlecommerceapis.exceptions.api_exception.APIException):
    def __init__(self, reason, response):
        """Constructor for the PostCIFLocationUnauthorizedException class
        ...
        """
        super(PostCIFLocationUnauthorizedException, self).__init__(reason, response)
