...
class LabellingMethodNotAllowedException(postnlecommerceapis.exceptions.api_exception.APIException):
    def __init__(self, reason, response):
        """Constructor for the LabellingMethodNotAllowedException class
        ...
        """
        super(LabellingMethodNotAllowedException, self).__init__(reason, response)
