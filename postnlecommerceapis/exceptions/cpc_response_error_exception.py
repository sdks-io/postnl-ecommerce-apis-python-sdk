...
class CpcResponseErrorException(postnlecommerceapis.exceptions.api_exception.APIException):
    def __init__(self, reason, response):
        """Constructor for the CpcResponseErrorException class
        ...
        """
        super(CpcResponseErrorException, self).__init__(reason, response)
